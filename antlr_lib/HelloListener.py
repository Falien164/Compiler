...
class HelloListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by HelloParser#single1.
    def enterSingle1(self, ctx:HelloParser.Single1Context):
        pass

    # Exit a parse tree produced by HelloParser#single1.
    def exitSingle1(self, ctx:HelloParser.Single1Context):
        pass


    # Enter a parse tree produced by HelloParser#sub.
    def enterSub(self, ctx:HelloParser.SubContext):
        pass

    # Exit a parse tree produced by HelloParser#sub.
    def exitSub(self, ctx:HelloParser.SubContext):
        pass


    # Enter a parse tree produced by HelloParser#single2.
    def enterSingle2(self, ctx:HelloParser.Single2Context):
        pass

    # Exit a parse tree produced by HelloParser#single2.
    def exitSingle2(self, ctx:HelloParser.Single2Context):
        pass


    # Enter a parse tree produced by HelloParser#mul.
    def enterMul(self, ctx:HelloParser.MulContext):
        pass

    # Exit a parse tree produced by HelloParser#mul.
    def exitMul(self, ctx:HelloParser.MulContext):
        pass


    # Enter a parse tree produced by HelloParser#single3.
    def enterSingle3(self, ctx:HelloParser.Single3Context):
        pass

    # Exit a parse tree produced by HelloParser#single3.
    def exitSingle3(self, ctx:HelloParser.Single3Context):
        pass


    # Enter a parse tree produced by HelloParser#div.
    def enterDiv(self, ctx:HelloParser.DivContext):
        pass

    # Exit a parse tree produced by HelloParser#div.
    def exitDiv(self, ctx:HelloParser.DivContext):
        pass
