...
class LLVMGenerator:
    ...
    def printf_undefined_i32(self, id):
        self.main_text +="%" +str(self.reg)+" = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]*  @strpi, i32 0, i32 0), i32 "+id+")\n"
        self.reg+=1
    ...
    def printf_undefined_real(self, id):
        self.main_text +="%" +str(self.reg)+" = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]*  @strpd, i32 0, i32 0), double "+id+")\n"
        self.reg+=1
    ...
    def assign_i32(self, id, value):
        self.main_text += "store i32 "+value+", i32* %"+id+"\n"
    ...
    def add_i32(self, val1, val2):
        self.main_text += "%"+str(self.reg)+" = add i32 "+val1+", "+val2+"\n"
        self.reg+=1
    
    @staticmethod
    def add_real(self, val1, val2):
        self.main_text += "%"+str(self.reg)+" = fadd double "+val1+", "+val2+"\n"
        self.reg+=1

    @staticmethod
    def sub_i32(self, val1, val2):
        self.main_text += "%"+str(self.reg)+" = sub i32 "+val2+", "+val1+"\n"
        self.reg+=1
    
    @staticmethod
    def sub_real(self, val1, val2):
        self.main_text += "%"+str(self.reg)+" = fsub double "+val2+", "+val1+"\n"
        self.reg+=1

    @staticmethod
    def mul_i32(self, val1, val2):
        self.main_text += "%"+str(self.reg)+" = mul i32 "+val1+", "+val2+"\n"
        self.reg+=1
    
    @staticmethod
    def mul_real(self, val1, val2):
        self.main_text += "%"+str(self.reg)+" = fmul double "+val1+", "+val2+"\n"
        self.reg+=1

    @staticmethod
    def div_i32(self, val1, val2):
        self.main_text += "%"+str(self.reg)+" = sdiv i32 "+val2+", "+val1+"\n"
        self.reg+=1
    
    @staticmethod
    def div_real(self, val1, val2):
        self.main_text += "%"+str(self.reg)+" = fdiv double "+val2+", "+val1+"\n"
        self.reg+=1

    @staticmethod
    def sitofp(self, id):
        self.main_text += "%"+str(self.reg)+" = sitofp i32 "+id+" to double\n"
        self.reg+=1

    @staticmethod
    def fptosi(self, id):
        self.main_text += "%"+str(self.reg)+" = fptosi double "+id+" to i32\n"
        self.reg+=1
